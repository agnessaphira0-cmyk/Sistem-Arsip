...
<head>
    ...
    <title>Tambah Admin - Sistem Arsip PT Bank Sumut</title>
    <!-- Font Inter diselaraskan dengan halaman Login -->
    ...
    <style>
        ...
        .btn-save { background: var(--primary-blue); color: white; border-radius: 10px; padding: 10px 20px; border: none; font-weight: 600; box-shadow: 0 4px 12px rgba(0, 75, 135, 0.15); }
        .btn-save:hover { background: var(--dark-blue); color: white; }
...
<div class="main-content">
    <div class="topbar">
        <div>
            <h5 class="mb-1 fw-bold" style="color: var(--dark-blue)">Tambah Admin</h5>
            <small class="text-muted">Form pendaftaran akun sistem manajemen baru</small>
        </div>
        <a href="{{ route('user.index') }}" class="btn btn-light border btn-sm px-3 rounded-2">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama" class="form-control" placeholder="Masukkan nama lengkap petugas" value="{{ old('nama') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-dark">Username Akun <span class="text-danger">*</span></label>
                            <input type="text" name="username" class="form-control" placeholder="Contoh: bsumut_it99" value="{{ old('username') }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-dark">Kata Sandi / Password <span class="text-danger">*</span></label>
                            <input type="password" name="password" class="form-control" placeholder="Gunakan minimal 6 karakter kombinasi" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-dark">Ulangi Konfirmasi Kata Sandi <span class="text-danger">*</span></label>
                            <input type="password" name="password_confirmation" class="form-control" placeholder="Seleraskan dengan isi kolom password atas" required>
                        </div>
                        <div class="d-flex gap-2 pt-2 border-top">
                            <button type="submit" class="btn btn-save">
                                <i class="fas fa-save me-1"></i> Daftarkan Admin
                            </button>
                            <a href="{{ route('user.index') }}" class="btn btn-light border rounded-3 px-4">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
