...
<head>
    ...
    <title>Edit Rak - Sistem Arsip PT Bank Sumut</title>
...
<div class="main-content">
    <div class="topbar d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold" style="color: var(--dark-blue)"><i class="fas fa-edit me-2 text-warning"></i>Ubah Informasi Rak</h5>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('rak.update', $rak->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kode_rak" class="form-control" value="{{ old('kode_rak', $rak->kode_rak) }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-dark">Lokasi Penempatan <span class="text-danger">*</span></label>
                            <input type="text" name="lokasi" class="form-control" value="{{ old('lokasi', $rak->lokasi) }}" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-dark">Deskripsi Rak</label>
                            <textarea name="deskripsi" class="form-control" rows="3">{{ old('deskripsi', $rak->deskripsi) }}</textarea>
                        </div>
