...
<head>
    ...
    <title>Tambah Box - Sistem Arsip PT Bank Sumut</title>
...
<div class="main-content">
    <div class="topbar">
        <h5 class="mb-0 fw-bold" style="color: var(--dark-blue)"><i class="fas fa-plus-circle me-2 text-warning"></i>Tambah Box Arsip Baru</h5>
    </div>
            ...
            <div class="card card-form p-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('box.store') }}">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-dark">Kode Box <span class="text-danger">*</span></label>
                            <input type="text" name="kode_box" class="form-control" placeholder="Contoh: BOX-001" value="{{ old('kode_box') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-dark">Nama Box <span class="text-danger">*</span></label>
                            <input type="text" name="nama_box" class="form-control" placeholder="Contoh: Dokumen Kredit Pemko" value="{{ old('nama_box') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-dark">Pilih Lokasi Rak Pemilik <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-dark">Kapasitas Maksimal <span class="text-danger">*</span></label>
                            <input type="number" name="kapasitas" class="form-control" placeholder="Contoh: 50" value="{{ old('kapasitas', 50) }}" min=\"1\" required>
                            <small class="text-muted mt-1 d-block">Jumlah batas maksimal bundel dokumen di dalam box ini</small>
                        </div>
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-save">
                                <i class="fas fa-save me-1"></i> Simpan Box
                            </button>
